...
//                       "B0 63 00 B0 62 00 B0 60 00")
    ...
    func testSendLevelMessage() throws {
        XCTAssertEqual(toString(mixerMessages.sendLevelMessage(midiChannel: 1, sourceType: MixerEndpoint.input, sourceChannel: 1,
                                                               destType: MixerEndpoint.main, destChannel: 1, dbLevel: 0)),
                       "B0 63 40 B0 62 00 B0 06 76 B0 26 5C")
        XCTAssertEqual(toString(mixerMessages.sendLevelMessage(midiChannel: 1, sourceType: MixerEndpoint.input, sourceChannel: 1,
                                                               destType: MixerEndpoint.main, destChannel: 1, dbLevel: -20)),
                       "B0 63 40 B0 62 00 B0 06 64 B0 26 15")
        XCTAssertEqual(toString(mixerMessages.sendLevelMessage(midiChannel: 1, sourceType: MixerEndpoint.input, sourceChannel: 40,
                                                               destType: MixerEndpoint.main, destChannel: 1, dbLevel: -20)),
                       "B0 63 40 B0 62 27 B0 06 64 B0 26 15")
        XCTAssertEqual(toString(mixerMessages.sendLevelMessage(midiChannel: 1, sourceType: MixerEndpoint.input, sourceChannel: 40,
                                                               destType: MixerEndpoint.aux, destChannel: 5, dbLevel: -20)),
                       "B0 63 44 B0 62 1C B0 06 64 B0 26 15")
        XCTAssertEqual(toString(mixerMessages.sendLevelMessage(midiChannel: 4, sourceType: MixerEndpoint.input, sourceChannel: 40,
                                                               destType: MixerEndpoint.aux, destChannel: 5, dbLevel: -12)),
                       "B3 63 44 B3 62 1C B3 06 6B B3 26 4B")
        XCTAssertEqual(toString(mixerMessages.sendLevelMessage(midiChannel: 4, sourceType: MixerEndpoint.group, sourceChannel: 4,
                                                               destType: MixerEndpoint.aux, destChannel: 8, dbLevel: -24)),
                       "B3 63 45 B3 62 2F B3 06 60 B3 26 3B")
        XCTAssertEqual(toString(mixerMessages.sendLevelMessage(midiChannel: 14, sourceType: MixerEndpoint.input, sourceChannel: 36,
                                                               destType: MixerEndpoint.fxSend, destChannel: 3, dbLevel: -12)),
                       "BD 63 4D BD 62 22 BD 06 6B BD 26 4B")
    }

    func testPanMessage() throws {
        XCTAssertEqual(toString(mixerMessages.sendPanMessage(midiChannel: 1, sourceType: MixerEndpoint.input, sourceChannel: 1,
                                                             destType: MixerEndpoint.main, destChannel: 1, panLevel: -100)),
                       "B0 63 50 B0 62 00 B0 06 00 B0 26 00")
        XCTAssertEqual(toString(mixerMessages.sendPanMessage(midiChannel: 1, sourceType: MixerEndpoint.input, sourceChannel: 1,
                                                             destType: MixerEndpoint.main, destChannel: 1, panLevel: 0)),
                       "B0 63 50 B0 62 00 B0 06 3F B0 26 7F")
        XCTAssertEqual(toString(mixerMessages.sendPanMessage(midiChannel: 1, sourceType: MixerEndpoint.input, sourceChannel: 24,
                                                             destType: MixerEndpoint.main, destChannel: 1, panLevel: 20)),
                       "B0 63 50 B0 62 17 B0 06 4C B0 26 65")
        XCTAssertEqual(toString(mixerMessages.sendPanMessage(midiChannel: 1, sourceType: MixerEndpoint.input, sourceChannel: 24,
                                                             destType: MixerEndpoint.aux, destChannel: 5, panLevel: 20)),
                       "B0 63 52 B0 62 5C B0 06 4C B0 26 65")
        XCTAssertEqual(toString(mixerMessages.sendPanMessage(midiChannel: 4, sourceType: MixerEndpoint.input, sourceChannel: 24,
                                                             destType: MixerEndpoint.aux, destChannel: 5, panLevel: -50)),
                       "B3 63 52 B3 62 5C B3 06 1F B3 26 7F")
        XCTAssertEqual(toString(mixerMessages.sendPanMessage(midiChannel: 4, sourceType: MixerEndpoint.group, sourceChannel: 3,
                                                             destType: MixerEndpoint.aux, destChannel: 2, panLevel: -50)),
                       "B3 63 55 B3 62 1D B3 06 1F B3 26 7F")
        XCTAssertEqual(toString(mixerMessages.sendPanMessage(midiChannel: 11, sourceType: MixerEndpoint.main, sourceChannel: 1,
                                                             destType: MixerEndpoint.matrix, destChannel: 3, panLevel: 100)),
