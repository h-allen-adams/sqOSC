...
final class SqMixerEndpointsTest: XCTestCase {
    ...
    override func setUpWithError() throws {
        endpointRegistrar = SqOscEndpointRegistrar(dictionary: SqMixerEndpointDictionary(.sq),
    ...
    func testRegisterMutes() throws {
        ...
        XCTAssertEqual(callEndpoint("/input/48/mute ON"), "B0 63 00 B0 62 2F B0 06 00 B0 26 01")
        ...
        XCTAssertEqual(callEndpoint("/group/1/mute ON"), "B0 63 00 B0 62 30 B0 06 00 B0 26 01")
        XCTAssertEqual(callEndpoint("/group/12/mute ON"), "B0 63 00 B0 62 3B B0 06 00 B0 26 01")
        XCTAssertEqual(callEndpoint("/fxReturn/1/mute ON"), "B0 63 00 B0 62 3C B0 06 00 B0 26 01")
        XCTAssertEqual(callEndpoint("/fxReturn/8/mute ON"), "B0 63 00 B0 62 43 B0 06 00 B0 26 01")
    ...
    func testRegisterSendLevels() throws {
        ...
        XCTAssertEqual(callEndpoint("/input/48/to/main/sendLevel 0"),
        ...
        XCTAssertEqual(callEndpoint("/input/48/to/aux/1/sendLevel 0"),
        ...
        XCTAssertEqual(callEndpoint("/input/48/to/aux/12/sendLevel 0"),
        ...
        XCTAssertEqual(callEndpoint("/input/48/to/fxSend/1/sendLevel 0"),
        ...
        XCTAssertEqual(callEndpoint("/input/48/to/fxSend/4/sendLevel 0"),
    ...
    func testRegisterOutputBalance() throws {
        XCTAssertEqual(callEndpoint("/main/balance -100"),
