...
final class SqMixerMessagesTests: XCTestCase {
    ...
    func testSendLevelMessage() throws {
        XCTAssertEqual(mixerMessages.sendLevelMessage(midiChannel: 1, sourceType: SqChannelType.input, sourceChannel: 1,
                                                      destType: SqChannelType.main, destChannel: 1, dbLevel: 0), "B0 63 40 B0 62 00 B0 06 76 B0 26 5C")
        XCTAssertEqual(mixerMessages.sendLevelMessage(midiChannel: 1, sourceType: SqChannelType.input, sourceChannel: 1,
                                                      destType: SqChannelType.main, destChannel: 1, dbLevel: -20), "B0 63 40 B0 62 00 B0 06 64 B0 26 15")
        XCTAssertEqual(mixerMessages.sendLevelMessage(midiChannel: 1, sourceType: SqChannelType.input, sourceChannel: 40,
                                                      destType: SqChannelType.main, destChannel: 1, dbLevel: -20), "B0 63 40 B0 62 27 B0 06 64 B0 26 15")
        XCTAssertEqual(mixerMessages.sendLevelMessage(midiChannel: 1, sourceType: SqChannelType.input, sourceChannel: 40,
                                                      destType: SqChannelType.aux, destChannel: 5, dbLevel: -20), "B0 63 44 B0 62 1C B0 06 64 B0 26 15")
        XCTAssertEqual(mixerMessages.sendLevelMessage(midiChannel: 4, sourceType: SqChannelType.input, sourceChannel: 40,
                                                      destType: SqChannelType.aux, destChannel: 5, dbLevel: -12), "B3 63 44 B3 62 1C B3 06 6B B3 26 4B")
        XCTAssertEqual(mixerMessages.sendLevelMessage(midiChannel: 4, sourceType: SqChannelType.group, sourceChannel: 4,
                                                      destType: SqChannelType.aux, destChannel: 8, dbLevel: -24), "B3 63 45 B3 62 2F B3 06 60 B3 26 3B")
        XCTAssertEqual(mixerMessages.sendLevelMessage(midiChannel: 14, sourceType: SqChannelType.input, sourceChannel: 36,
                                                      destType: SqChannelType.fxSend, destChannel: 3, dbLevel: -12), "BD 63 4D BD 62 22 BD 06 6B BD 26 4B")
    }
