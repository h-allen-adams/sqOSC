...
#Preview {
    EndpointDictionaryDisplayPathView(len: 35, displayPath: SqMixerEndpointDictionary(mixerConfig: SqMixerConfig.defaultConfig()).entries[EndpointOperationType.sendLevel]!.displayPaths().first!)
}
