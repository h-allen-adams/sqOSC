...
#Preview {
    EndpointDictionaryDisplayPathView(len: 35,
                                      displayPath: SqMixerEndpointDictionary.forConfiguration(.sq, faderLaw: .LinearTaper)
                                          .entries[MixerMethod.sendLevel]!.displayPaths().first!)
}
